...
const ResearchCardContainerComponent = ({
  researchData,
  handlePopUpComponent,
}) => {
  ...
  return (
    <View
      ...
      <View style={researchStyle.cardContainer}>
        <LinearGradient
          start={{x: 0, y: 0}}
          end={{x: 1, y: 0}}
          colors={['rgba(98, 49, 173, 1)', 'rgba(254, 65, 144, 1)']}
          style={researchStyle.headerCardContainer}>
          <View
            style={{
              bottom: 0,
              right: 0,
...
export default ResearchCardContainerComponent;
